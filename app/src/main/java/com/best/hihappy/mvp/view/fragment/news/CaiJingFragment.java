...
public class CaiJingFragment extends BaseFragment implements NewsView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = "CaiJingFragment";

    @Override
    protected void LoadData() {
        if (isVisible && isFirst) {
            mNewsPresenter.requestData("caijing");
            isFirst = false;
        }
